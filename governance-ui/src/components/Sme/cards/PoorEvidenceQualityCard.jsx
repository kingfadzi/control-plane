...
const PoorEvidenceQualityCard = () => (
    <GovernanceCard
        title="Controls With Poor Evidence Quality"
        items={items}
        maxVisible={4}
        modalTitle="Controls With Poor Evidence Quality"
        renderItem={(item) => (
...
export default PoorEvidenceQualityCard;
