...
const items = [{'title': 'GitLab Repo', 'owner': 'DevOps', 'status': 'Complete'}, {'title': 'Jira Board', 'owner': 'PMO', 'status': 'Complete'}, {'title': 'ServiceNow CR', 'owner': 'Release Manager', 'status': 'Complete'}];
...
const GovernanceLinksCard = () => (
    <GovernanceCard
        ...
        items=[{'title': 'GitLab Repo', 'owner': 'DevOps', 'status': 'Complete'}, {'title': 'Jira Board', 'owner': 'PMO', 'status': 'Complete'}, {'title': 'ServiceNow CR', 'owner': 'Release Manager', 'status': 'Complete'}]
        maxVisible={3}
        modalTitle="Full Governance Links"
        renderItem={{(item) => {{
