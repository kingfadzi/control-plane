...
const WideGovernanceCard = ({ title, items, maxVisible = 4, modalTitle, renderItem }) => {
    ...
    return (
        <>
            <div className="flex flex-col h-full min-h-[220px] rounded-lg bg-white shadow-sm w-full max-w-[768px] p-4 border border-slate-200">
...
export default WideGovernanceCard;
